      ...
      <div className="m-3 sm:m-5">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            ...
            <div className="bg-yellow-50 p-4 rounded-md border border-yellow-100 shadow-sm">
            ...
            <table className="min-w-full bg-white">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Day Off</th>
                  <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                  <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Day Off Status</th>
                </tr>
              </thead>
